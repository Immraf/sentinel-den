...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Isolated VirtualBox SIEM lab with SOC console, detection scenarios and hardening report." },
      { name: "author", content: "SOC Lab" },
      { property: "og:title", content: "SIEM & Log Monitoring Lab" },
